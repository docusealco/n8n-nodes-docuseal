...
async function createSubmission(this: IExecuteFunctions, i: number): Promise<IDataObject> {
...
async function createSubmissionFromDocx(this: IExecuteFunctions, i: number): Promise<IDataObject> {
...
async function createSubmissionFromHtml(this: IExecuteFunctions, i: number): Promise<IDataObject> {
	const name = this.getNodeParameter('name', i, '') as string;
	const sendEmail = this.getNodeParameter('sendEmail', i) as boolean;
	const sendSms = this.getNodeParameter('sendSms', i) as boolean;
	const emailSubject = this.getNodeParameter('emailSubject', i, '') as string;
...
async function createSubmissionFromPdf(this: IExecuteFunctions, i: number): Promise<IDataObject> {
	const name = this.getNodeParameter('name', i, '') as string;
	const sendEmail = this.getNodeParameter('sendEmail', i) as boolean;
	const sendSms = this.getNodeParameter('sendSms', i) as boolean;
	const emailSubject = this.getNodeParameter('emailSubject', i, '') as string;
