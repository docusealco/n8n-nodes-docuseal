...
export const createSubmissionFromDocxDescription: INodeProperties[] = [
  {
    ...
    displayOptions: {
      show: {
        operation: ['createSubmissionFromDocx'],
      },
    },
  },
  {
    ...
    default: {},
    description: 'Dynamic content variables object. Variable values can be strings, numbers, arrays, objects, or HTML content.',
    options: [
      {
        name: 'pair',
  ...
  },
  {
    ...
    default: {},
    description: 'DOCX or PDF documents to include in the submission',
    options: [
      {
        name: 'document',
  ...
  },
  {
    ...
    default: 'preserved',
    description: "If 'random', all parties are notified right away. If 'preserved', signers are notified sequentially.",
    displayOptions: {
      show: {
        operation: ['createSubmissionFromDocx'],
      },
